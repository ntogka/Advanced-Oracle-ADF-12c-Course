...
public class AppModuleServiceSoapHttpPortClient
{
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      String deptName = appModuleService.getCustomDeptName(10);
  ...
  public static void setPortCredentialProviderList(Map<String, Object> requestContext)
    throws Exception
  {
  ...
  public static CredentialProvider getBSTCredentialProvider(String clientKeyStore, String clientKeyStorePwd,
                                                            ...
                                                            String serverKeyAlias, Map<String, Object> requestContext)
    throws Exception
  {
