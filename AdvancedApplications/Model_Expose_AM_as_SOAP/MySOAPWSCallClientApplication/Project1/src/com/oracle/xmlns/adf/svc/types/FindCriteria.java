 ...
 *         &lt;element name="findAttribute" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="500" minOccurs="0"/&gt;
 *         &lt;element name="excludeAttribute" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *         &lt;element name="childFindCriteria" type="{http://xmlns.oracle.com/adf/svc/types/}ChildFindCriteria" maxOccurs="500" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "FindCriteria",
         propOrder =
         { "fetchStart", "fetchSize", "filter", "sortOrder", "findAttribute", "excludeAttribute", "childFindCriteria"
  })
@XmlSeeAlso({ ChildFindCriteria.class })
