...
public class ObjectFactory
{
  ...
  private final static QName _ProcessControl_QNAME =
    new QName("http://xmlns.oracle.com/adf/svc/types/", "processControl");
   ...
   * @return
   *     the new instance of {@link JAXBElement }{@code <}{@link FindCriteria }{@code >}
   */
   ...
   *     Java instance representing xml element's value.
   * @return
   *     the new instance of {@link JAXBElement }{@code <}{@link FindControl }{@code >}
   */
   ...
   *     Java instance representing xml element's value.
   * @return
   *     the new instance of {@link JAXBElement }{@code <}{@link ProcessControl }{@code >}
   */
