...
@XmlType(name = "MethodResult", propOrder = { "message" })
@XmlSeeAlso({ BigDecimalResult.class, BigIntegerResult.class, BooleanResult.class, ByteResult.class, BytesResult.class,
              TimestampResult.class, TimeResult.class, DateResult.class, DoubleResult.class, FloatResult.class,
              IntegerResult.class, LongResult.class, ShortResult.class, StringResult.class, DataHandlerResult.class,
