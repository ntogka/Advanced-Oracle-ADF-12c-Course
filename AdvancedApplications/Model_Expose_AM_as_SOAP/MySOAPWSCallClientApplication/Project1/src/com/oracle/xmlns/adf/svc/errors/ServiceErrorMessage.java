...
@XmlType(name = "ServiceErrorMessage", propOrder = { "sdoObject", "exceptionClassName" })
@XmlSeeAlso({ ServiceAttrValErrorMessage.class, ServiceRowValErrorMessage.class, ServiceDMLErrorMessage.class })
