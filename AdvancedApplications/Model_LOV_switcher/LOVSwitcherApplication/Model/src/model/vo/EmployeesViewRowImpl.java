  ...
  extends ViewRowImpl
{
  ...
  public static final int DEPARTMENTLOVSWITCHER = AttributesEnum.DepartmentLOVSwitcher.index();
  ...
  public static final int DEPARTMENTSVIEW2 = AttributesEnum.DepartmentsView2.index();
  ...
  /**
   * Gets the attribute value for the calculated attribute DepartmentLOVSwitcher.
   * @return the DepartmentLOVSwitcher
   */
  public String getDepartmentLOVSwitcher()
  {
    
    
    if(getSalary() != null && getSalary().doubleValue() <= 5000)
    {
      return "LOV_DepartmentIdLessThan50";
    }
    
    return "LOV_DepartmentIdGreaterThan50";
    
    //return (String) getAttributeInternal(DEPARTMENTLOVSWITCHER);
  }
  ...
  /**
   * Gets the view accessor <code>RowSet</code> DepartmentsView1.
   */
  public RowSet getDepartmentsView1()
  {
    return (RowSet) getAttributeInternal(DEPARTMENTSVIEW1);
  }

  /**
   * Gets the view accessor <code>RowSet</code> DepartmentsView2.
   */
  public RowSet getDepartmentsView2()
  {
    return (RowSet) getAttributeInternal(DEPARTMENTSVIEW2);
  }
}
